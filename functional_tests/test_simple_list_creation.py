...
class NewVisitorTest(FunctionalTest):
    ...
    def test_can_start_a_list_for_one_user(self):
        ...
        # She notices the page title and header must mention to-do lists
        self.assertIn('To-Do', self.browser.title)
        header_text = self.browser.find_element_by_tag_name('h1').text
        self.assertIn('To-Do', header_text)

        # She is inveited to enter a to-do item straight away
        ...
        # There is still a text box iniviting her to add another item. She
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        # Now a new user, Franics, comes along to the site.
